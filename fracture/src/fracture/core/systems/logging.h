 ...
 */
FR_API void fr_log_message_detailed(log_level level, log_source source, const char* file, int line, const char* format, ...);
...
#define FR_CORE_FATAL_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_FATAL, LOG_SOURCE_ENGINE, __FILE__, __LINE__, format, ##__VA_ARGS__)

#define FR_CORE_ERROR(format, ...) fr_log_message(LOG_LEVEL_ERROR, LOG_SOURCE_ENGINE, format, ##__VA_ARGS__)
#define FR_CORE_ERROR_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_ERROR, LOG_SOURCE_ENGINE, __FILE__, __LINE__, format, ##__VA_ARGS__)

#if ENABLE_WARN_LOGGING == 1
    #define FR_CORE_WARN(format, ...) fr_log_message(LOG_LEVEL_WARN, LOG_SOURCE_ENGINE, format, ##__VA_ARGS__)
    #define FR_CORE_WARN_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_WARN, LOG_SOURCE_ENGINE, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
    ...
    #define FR_CORE_INFO_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_INFO, LOG_SOURCE_ENGINE, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
    ...
    #define FR_CORE_TRACE_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_TRACE, LOG_SOURCE_ENGINE, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
...
#define FR_FATAL_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_FATAL, LOG_SOURCE_CLIENT, __FILE__, __LINE__, format, ##__VA_ARGS__)

#define FR_ERROR(format, ...) fr_log_message(LOG_LEVEL_ERROR, LOG_SOURCE_CLIENT, format, ##__VA_ARGS__)
#define FR_ERROR_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_ERROR, LOG_SOURCE_CLIENT, __FILE__, __LINE__, format, ##__VA_ARGS__)

#if ENABLE_WARN_LOGGING == 1
    #define FR_WARN(format, ...) fr_log_message(LOG_LEVEL_WARN, LOG_SOURCE_CLIENT, format, ##__VA_ARGS__)
    #define FR_WARN_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_WARN, LOG_SOURCE_CLIENT, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
    ...
    #define FR_INFO_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_INFO, LOG_SOURCE_CLIENT, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
    ...
    #define FR_TRACE_DETAILED(format, ...) fr_log_message_detailed(LOG_LEVEL_TRACE, LOG_SOURCE_CLIENT, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else
