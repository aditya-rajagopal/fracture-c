...
FR_FORCE_INLINE void fr_vec4_s(f32 s, vec4* dest) {
#if FR_SIMD == 1
...
FR_FORCE_INLINE void fr_vec4_ieqv(const vec4* a, const vec4* b, bvec4* dest) {
#if FR_SIMD == 1
