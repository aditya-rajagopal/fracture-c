...
FR_FORCE_INLINE void fr_affine_rotate_around_to(
    const mat4* transform, const vec3* pivot, f32 angle, const vec3* axis, mat4* result) {
...
FR_FORCE_INLINE void fr_affine_quat_rotate_around(const mat4* transform,
                                                  const vec3* pivot,
                                                  const quat* rotation,
                                                  mat4* out_transform) {
    mat4 rot_mat;
