...
/**
 * @brief Initializes the platform layer with the given parameters and returns a platform state that can be used to
 * communicate with the platform layer.
 *
...
/**
 * @brief Shuts down the platform layer and frees any resources that were allocated during the platform_startup
 * function.
 *
 ...
 * @details if the memory is NULL, the function will return the size of the memory required to write the handle
 * information to.
